...
const hotnew = [{'name':'Quang Huy','detail':'Vừa tham gia vòng quay may mắn và trúng voucher giảm giá 50% cho mọi sản phẩm trên website','img':''},
                {'name':'Quang Hà','detail':'Vừa săn được vé xem phim chỉ với 9k','img':''},
                {'name':'Quang Hải','detail':'Thực hiện thành công chương trình mời bạn bè tham gia quay số trúng thưởng','img':''},
                {'name':'Quang Linh','detail':'Vừa nhận được ưu đãi cho thành viên mới','img':''}
              ]
const News = () => {
      ...
      <div className='news-container'>
        ...
        <div className='new-hot'>
          <List sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper' }}>
            <center><h1 style={{color:'red'}}>Tin Mới</h1></center>
            {hotnew.map((row)=>(
